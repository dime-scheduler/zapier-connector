...
const fields = [
    ...
    { key: 'urlType', label: 'Url Type', type: "string", required: true },
    { key: 'url', label: 'Url', type: "string", required: true },
    { key: 'urlDesc', label: 'Url Desc', type: "string", required: true },
    { key: 'defaultUrl', label: 'Default Url', type: "string", required: true },
];
